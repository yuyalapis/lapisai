...
from v1.agents.first_smart_agent import FirstSmartAgent
...
for i in range(10):
  ...
  print(knight.sight)
  logs.append((tuple(knight.sight), knight.previous_decision))
  if "o" in knight.sight:
    knight.save_valid_logs(logs)
